...
define("startLine", ["require", "exports"], function (require, exports) {
    "use strict";
    ...
    class StartLine {
        static line() {
            try {
                ...
                return locationException.stack.split("\n")[1].split("chrome-extension://")[1].split(":")[1] - 6;
            }
        }
    }
...
// @ts-ignore
define("Bar/Site", ["require", "exports", "Bar/Bar", "environment"], function (require, exports, Bar_2, environment_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Site {
        constructor(href, fnc, runInFrame = false, runAtIndex = 3, isRefreshing = -1) {
            this.href = href;
            this.fnc = fnc;
            this.runInFrame = runInFrame;
            this.runAtIndex = runAtIndex;
            this.isRefreshing = isRefreshing;
            //runat 0=script start ,1 -5=domloaded
            environment_7.Environment.sc.c.main_sites.push(this);
            if (this.isRefreshing > 0) {
                environment_7.Environment.sc.c.site_checkurls.push({
                    site: this.href,
                    time: isRefreshing * 1000 * 60
                });
            }
            return this;
        }
        isRunning(site = location.href.replace(location.hash, "")) {
            if (this.href instanceof Array) {
                if (this.href.some((hrf) => site.includes(hrf))) {
                    return true;
                }
            }
            else {
        ...
        run() {
            ...
            ;
            if (location.hash !== "") {
                let ar = location.hash.replace("#", "").split("&");
                ar.forEach((currentHash) => {
                    let o = currentHash.split("=");
                    hash[o[0]] = o[1];
                });
            }
            try {
                environment_7.Environment.sc.D.lastSiteRun = this;
                this.fnc(hash, Bar_2.Bar.menus, environment_7.Environment.sc);
            }
            catch (err) {
                environment_7.Environment.sc.D.e(err, undefined, 5, "error in '" + this.href + "'");
            }
        }
    }
    exports.Site = Site;
...
// @ts-ignore
define("sc/HTTPRequests", ["require", "exports", "environment"], function (require, exports, environment_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class HTTPRequests {
        constructor(sc) {
        ...
        g(url, requestHeader = [], c, PW = []) {
            ...
            http.onreadystatechange = this.onReadyStateChangeGET(http, c);
            http.send();
        }
        onReadyStateChangeGET(http, c) {
            return function () {
                if (http.readyState === 4 && http.status === 200) {
                    ...
                    try {
                        ...
                        environment_8.Environment.sc.D.e(error);
                    }
                }
            };
        }
        onReadyStateChangePOST(http, c) {
            return function () {
                if (http.readyState === 4 && http.status === 200) {
                    this.sc.D.l(http.responseText);
                    c.call(this, http);
                }
            };
        }
        s(url, requestHeader, c, params) {
            let http = new XMLHttpRequest();
            let form = "series%5B%5D=";
            ...
            http.onreadystatechange = this.onReadyStateChangePOST(http, c);
            http.send(params);
        }
    }
...
define("sc/DOM/DOM", ["require", "exports", "environment"], function (require, exports, environment_9) {
    ...
    class DOM {
        ...
        crTF(appendto, text, onEnter, purging = true, val = undefined, style) {
            let object = document.createElement("input");
            appendto.appendChild(object);
            object['val'] = val;
            object.type = "width";
...
// @ts-ignore
define("sc/Math", ["require", "exports", "sc/Vector2"], function (require, exports, Vector2_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Math {
        constructor(sc) {
            this.sc = sc;
            this.Vector2 = Vector2_1.Vector2;
        }
    }
    exports.Math = Math;
});
// @ts-ignore
define("sc/Tabs", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Tabs {
        constructor() {
            this.gT = window['GM_getTab'];
            this.sT = window['GM_saveTab'];
            this.gTs = window['GM_getTabs'];
        }
    }
    exports.Tabs = Tabs;
});
...
// @ts-ignore
define("sc/libraries", ["require", "exports", "sc/Storage/localStorage", "sc/Storage/sessionStorage", "sc/constants", "sc/debug", "sc/time", "sc/HTTPRequests", "sc/Storage/grease-storage", "sc/DOM/DOM", "sc/Math", "sc/Anim/Animations", "sc/Tabs", "Security", "sc/find"], function (require, exports, localStorage_1, sessionStorage_1, constants_1, debug_1, time_1, HTTPRequests_1, grease_storage_1, DOM_1, Math_1, Animations_2, Tabs_1, Security_1, find_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class libraries {
        constructor() {
            /*this.g.I = function getById(string: string, iF): HTMLElement {
                if (iF !== undefined) {
            ...
            this.g.C = function className(string: string, iF: HTMLElement, compress: boolean = true): HTMLElement | HTMLCollectionOf<HTMLElement> {
    
                let list: HTMLCollectionOf<HTMLElement>;
    
                if (iF !== undefined) {
                    if (iF.localName === "iframe") {
                        list = iF['contentDocument'].getElementsByClassName(string);
                    } else {
                        list = iF.getElementsByClassName(string) as HTMLCollectionOf<HTMLElement>;
    
                    }
                } else {
                    list = document.getElementsByClassName(string) as HTMLCollectionOf<HTMLElement>;
                }
            ...
            this.g.T = function tag(string: string, iF: Element, compress: boolean = true): HTMLElement | HTMLCollectionOf<HTMLElement> {
    
                var list: HTMLCollectionOf<HTMLElement>;
    
                if (iF !== undefined) {
                    if (iF.localName === "iframe") {
                        list = iF['contentDocument'].getElementsByTagName(string);
                    } else {
                        list = iF.getElementsByTagName(string) as HTMLCollectionOf<HTMLElement>;
    
                    }
                } else {
                    list = window.document.getElementsByTagName(string) as HTMLCollectionOf<HTMLElement>;
            ...
            this.g.c0 = function child(element: HTMLElement, count: number = 0): HTMLElement {
                if (count === 0) {
                    return element;
                }
                return child(element.children[0] as HTMLElement, count - 1);
            };
            this.g.W = function (top: boolean = false, wnd: Element): any {
                ...
                if (top) {
                    ...
                    if (wnd.parentElement !== undefined) {
                        return this.g.W(true, wnd.parentElement);
            ...
            this.g.a = async function get(identification: string, parent: Element, tag: string): Promise<Element> {
                if (parent) {
                ...
                return new Promise<Element>((resolve, reject) => {
                    function waitTillDefined(identification: string): void {
                        let obj = this.g(identification, parent);
                        ...
                        if (obj) {
                            ...
                            setTimeout(waitTillDefined, 100, identification);
                        }
                    }
                    setTimeout(waitTillDefined, 1, identification);
                });
            }*/
            this.c = new constants_1.Constants();
            this.scr = {};
            this.L = new localStorage_1.LocalStorage(this);
            //rest in constructor
            /* g: ElementGetter = <ElementGetter>function (string: String, iF?: Element, compress?: boolean): Element | HTMLCollectionOf<Element> {
         
                 if (!compress) {
                     compress = true;
                 }
                 var obj = this.g.I(string);
                 if (!obj) {
                     obj = this.g.C(string, iF, compress);
                 }
                 if (!obj) {
                     obj = this.g.T(string, iF, compress);
                 }
                 return obj;
             };*/
            this.DOM = new DOM_1.DOM(this);
            this.S = new sessionStorage_1.SessionStorage(this);
            this.D = new debug_1.Debug(this);
            this.T = new time_1.Time(this);
            this.G = new grease_storage_1.GreaseStorage(this);
            this.X = new HTTPRequests_1.HTTPRequests(this);
            this.M = new Math_1.Math(this);
            this.t = new Tabs_1.Tabs();
            this.g = find_5.default;
            this.sec = Security_1.Security.libMethods();
            this.Animations = new Animations_2.Animations(this);
        }
    }
...
// @ts-ignore
define("Sites/twitter", ["require", "exports", "environment", "sc/find"], function (require, exports, environment_12, find_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Twitter {
        constructor() {
            this.btnTimestamp = environment_12.Environment.sc.T.n();
            this.textMap = new Map();
        }
        main() {
            try {
                let btn = environment_12.Environment.sc.DOM.crBE(find_7.default("stream-container conversations-enabled").children[0], "LOAD TWEETS", (button) => { this.load.call(this, button); }, function (btn) {
                    btn.style.backgroundColor = "#25aafd";
                }, function (btn) {
                    btn.style.backgroundColor = "#1da1f2";
                        ...
                        style: {
                            ...
                            position: "relative",
                            width: find_7.default("stream-items-id").clientWidth.toString() + "px",
                            height: "27pt",
                ...
                btn['btnTimestamp'] = 0;
                this.loadTweetsButton = btn;
            }
            catch (e) {
                environment_12.Environment.sc.D.e(e);
            }
        }
        load(button) {
            let instance = this;
            debugger;
            let now = environment_12.Environment.sc.T.n();
            if (button.btnTimestamp + 1000 < now) {
                button.btnTimestamp = now;
                var tweets = document.getElementById("stream-items-id").children;
                // @ts-ignore
                instance.topTweet = tweets[0].id;
                var tweettext = "";
                try {
                    if (document.getElementById("stream-items-id").children[0].children[0].children[2]) {
                        tweettext = document.getElementById("stream-items-id").children[0].children[0].children[2].children[0].children[1].children[2].textContent;
                    }
                    else {
                        if (document.getElementById("stream-items-id").children[0].children[0].children[1].children[1]) {
                            tweettext = "RETWEET\n" + document.getElementById("stream-items-id").children[0].children[0].children[1].children[1].textContent;
                        }
                        else {
                            tweettext = document.getElementById("stream-items-id").children[0].children[0].children[1].children[0].children[1].children[2].textContent;
                        }
                    }
                }
                catch (e) {
                ...
                while (tweets.length > 7) {
                    ...
                    tweets = document.getElementById("stream-items-id").children;
                }
                let newTweetsBar = find_7.default("new-tweets-bar js-new-tweets-bar");
                if (newTweetsBar) {
                    let index = newTweetsBar.attributes["data-item-count"].nodeValue - 0;
                    let t = document.getElementById("stream-items-id").children;
                    newTweetsBar.click();
                    environment_12.Environment.sc.D.sT(function goto() {
                        function scroll(ct = 0) {
                            let max = 100;
                            let t = [...document.getElementById("stream-items-id").children];
                            // @ts-ignore
                            window.scrollTo(0, t[t.length - 1].offsetTop);
                            if (t.length < max) {
                                if (ct < 10) {
                                    environment_12.Environment.sc.D.sT(scroll, 100, ct + 1);
                                }
                            }
                            else {
                                // @ts-ignore
                                window.scrollTo(0, t[max].offsetTop - 500);
                                return;
                            }
                        }
                        // @ts-ignore
                        console.log(instance.topTweet);
                        try {
                            // @ts-ignore
                            console.log("scrolling to id : " + instance.topTweet + " text: " + tweettext);
                            // @ts-ignore
                            window.scrollTo(0, document.getElementById(instance.topTweet.toString()).offsetTop - 500);
                        }
                        catch (e) {
                            debugger;
                            //cannot read offsettop of null
                            //scroll();
                            //sc.D.e(e);
                        }
                        ...
                        for (let i = 0; i < t.length - 1; i++) {
                            let p2;
                            if (t[i].children[0] && t[i].children[0].children[1] && t[i].children[0].children[1].children[0].children[0] &&
                                t[i].children[0].children[1].children[0].children[0].children[1]) {
                                p2 = t[i].children[0].children[1].children[0].children[0].children[1];
                            }
                            if (p2) {
                                let element = p2.children[0];
                                if (!instance.textMap.has(element)) {
                                    instance.textMap.set(element, { key: element.textContent, value: i });
                                }
                                instance.textMap.get(element).value = i;
                                element.textContent = instance.textMap.get(element).value + " " + instance.textMap.get(element).key;
                            }
                            else {
                                //refresh button
                            }
                    ...
                    environment_12.Environment.sc.D.l("loading new tweets button doesnt exist");
                }
            }
            else {
                environment_12.Environment.sc.D.l("no double click");
            }
        }
    }
...
define("Sites/sites", ["require", "exports", "Bar/Site", "environment", "sc/Video", "Bar/Bar", "Bar/Table", "Sites/twitter", "sc/find"], function (require, exports, Site_1, environment_13, Video_1, Bar_3, Table_2, twitter_1, find_8) {
    ...
    class Sites {
        static init() {
            ...
            new Site_1.Site("https://www.facebook.com/", function facebook() {
                let container = find_8.default("pagelet_dock");
                if (container) {
                    let notificationcontainer = container.children[1];
                    if (notificationcontainer) {
                        environment_13.Environment.sc.D.aL(notificationcontainer, "DOMNodeInserted", function (e) {
                            let parent = e.target;
                            if (true) {
                                environment_13.Environment.sc.D.aL(parent, "DOMNodeInserted", function (e) {
                                    let o = e.target;
                                    let text = o.children[0].innerText;
                                    let link = o.children[0].children[1].href;
                                    if ((text.indexOf("commented") > -1 && (text.indexOf("your post") > -1 || text.indexOf("their post") > -1)) || text.indexOf("also replied to") > -1) {
                                        open(link);
                                        o.remove();
                                    }
                                });
                        ...
                        environment_13.Environment.sc.D.sT(facebook, 500);
                    }
                }
            }, false, 1);
            /* new Site("tinder.com", function () {
                function getOpenedProfile() {
                    let profile = find.C("profileCard");
                    if (profile) {
                        let bio = find.C("profileCard__bio") as HTMLElement;
                        if (!bio) {
                            find("recsGamepad__button--dislike").click();
                            Environment.sc.D.sT(getProfile, 20 + Math.random() * 500);
                        } else {
                            let biotxt = bio.innerText;
                            Environment.sc.D.sT(getProfile, 500);
                        }
                    } else {
                        Environment.sc.D.sT(getOpenedProfile, 100);
                    }
                }
                function getProfile() {
                    let profile = find.C("recsCardboard");
                    if (profile && find.C("recCard__openProfile")) {
                        find.C("recCard__openProfile")[0].click();
                        Environment.sc.D.sT(getOpenedProfile, 50 + Math.random() * 1000);
                    } else {
                        Environment.sc.D.sT(getProfile, 100);
                    }
                }
                getProfile();
            }, false); */
            new Site_1.Site("https://www.google.de/", function () {
                debugger;
                while (document.body.children[1]) {
                    document.body.children[1].remove();
                }
            }, false, 1);
            /*new Site("rabb.it", function rabbit() {
                var cont = find("sessions ui-draggable ui-draggable-handle ui-draggable-disabled");
                if (cont && false) {
                    Environment.sc.D.aL(cont, "DOMNodeInserted", function (a, b, c) {
                        var vidc = a.target;
                        if (vidc.className !== "userSessionBubble userSessionView") {
                            return;
                        }
                        Environment.sc.D.sT(function (vidc) {
                            var vid = find("video", vidc);
                            if (vid) {
                                var name = find("userName", vid.parentElement.parentElement).innerText;
                                var list = Environment.sc.L.g(Environment.sc.c.sI.LS.rabbit_volume, []);
                                var vol = 1;
                                for (var i = 0; i < list.length; i++) {
                                    if (list[i].username === name) {
                                        //vid.volume = list[i].volume/100;
                                        vol = list[i].volume / 100;
                                    }
                                }
                                var slider = find("ui-slider-handle ui-state-default ui-corner-all", vid.parentElement.parentElement);
                                slider.uN = name;
                                slider.onmouseup = function (a, b) {
                                    var vol = a.target.style.left.replace("%", "");
                                    var list = Environment.sc.L.g(Environment.sc.c.sI.LS.rabbit_volume, []);
                                    var found = false;
                                    for (var i = 0; i < list.length; i++) {
                                        if (list[i].username === a.target.uN) {
                                            found = true;
                                            list[i].volume = vol;
                                        }
                                    }
                                    if (!found) {
                                        list.push({ username: a.target.uN, volume: vol });
                                    }
                                    Environment.sc.L.s(Environment.sc.c.sI.LS.rabbit_volume, list);
                                };
                            }
                        }, 500, vidc);
                    });
                    var vsl = Environment.sc.DOM.crSL(document.body, function (a, b) {
                        var vids = find.T("video");
                        for (var i = 2; i < vids.length; i++) {
                            // vids[i].volume=b/100;
                        }
                    }, 100);
                    vsl.style.position = "fixed";
                    vsl.style.width = "100px";
                    vsl.style.top = find("tray shown").offsetTop + 105 + "px";
                    vsl.style.left = "60px";
                    vsl.style.border = "0px solid white";
                    vsl.style.backgroundColor = "transparent";
                } else {
                    //sc.D.sT(rabbit, 500);
                }
                var lastmove = Environment.sc.T.n();
                var hidden = false;
                document.onmousemove = function (e) {
                    lastmove = Environment.sc.T.n();
                    if (hidden === true && Environment.sc.L.g("hideshowenabled", true)) {
                        show();
                    }
                };
                function hide() {
                    find("toolbar").style.visibility = "hidden";
                    var barbtn = find("toolbarButton moreButton");
                    if (barbtn) {
                        barbtn.click();
                    }
                    setTimeout(function () {
                        var bbl = find("toolbarMenuItem hideBubblesItem off");
                        if (bbl) {
                            bbl.click();
                            hidden = true;
                        }
                ...
                function show() {
                    find("toolbar").style.visibility = "visible";
                    var barbtn = find("toolbarButton moreButton");
                    if (barbtn) {
                        barbtn.click();
                    }
                    setTimeout(function () {
                        var bbl = find("toolbarMenuItem hideBubblesItem on");
                        if (bbl) {
                            bbl.click();
                            hidden = false;
                        }
                ...
                function mcheck() {
                    if (Environment.sc.T.n() - lastmove > 2000) {
                        if (hidden === false && Environment.sc.L.g("hideshowenabled", true)) {
                            hide();
                        }
                    }
                    Environment.sc.D.sT(mcheck, 2000);
                }
                function addlisten() {
                    var obj = find("socialToolbarWrapper");
                    if (obj) {
                        Environment.sc.D.aL(find("socialToolbarWrapper").children[3].children[0], "att", function (evt) {
                            if (evt[0].target.className === "toolbarButtonView") {
                                if (find("toolbarButton chatButton on") === undefined) {
                                    find("toolbar").style.visibility = "visible";
                                    var btn = find("toolbarButton chatButton");
                                    if (btn[0] !== undefined) {
                                        btn = btn[0];
                                    }
                ...
                addlisten();
                Environment.sc.D.sT(mcheck, 10 * 1000);
                Environment.sc.D.sT(function () {
                    //debugger;
                    ...
                    img2.onload = function (event) {
                        ...
                        img3.style.visibility = !sc.L.g("hideshowenabled", true) ? "hidden" : "visible";
                        img3.onclick = function () {
                            Environment.sc.L.s("hideshowenabled", false);
                        ...
                        img.onclick = function () {
                            Environment.sc.L.s("hideshowenabled", true);
                            img3.style.visibility = "visible";
                        };
                        find("barLeft").appendChild(img);
                        find("barLeft").appendChild(img3);
                    };
                }, 3 * 1000);
            }, false);
            new Site("www.google.com/recaptcha/api2", function () {
                return;
                Environment.sc.D.sT(function () {
    
                    var checkbox = find.C("recaptcha-checkbox-checkmark");
                    if (checkbox) {
                        Environment.sc.D.sT(function () {
                            checkbox.click();
                        }, Math.random() * 1000);
                    ...
                    Environment.sc.D.sT(function () {
                        var imgwr = find.C("rc-image-tile-wrapper");
                            ...
                            img.onload = function (event) {
                                ...
                                for (var i = 0; i < event.target.length; i++) {
                                    for (var j = 0; j < event.target.length; j++) {
                                        ...
                                        var container = find.T("tbody").children;
                                        var obj = container[j].children[i].children[0].children[0].children[0];
                                        obj.data = data;
                                        obj.onclick = function (ev) {
                                            var tag;
                                            if (find.C("rc-imageselect-desc-wrapper").children[1].children[0]) {
                                                tag = find.C("rc-imageselect-desc-wrapper").children[1].children[0].innerText;
                                            } else if (find.C("rc-imageselect-desc-wrapper").children[0].children[0]) {
                                                tag = find.C("rc-imageselect-desc-wrapper").children[0].children[0].innerText;
                                            }
                                            Environment.sc.G.p("googlecaptchatemp", { data: ev.target.data, tag: tag }, []);
                                        };
                                    }
                                }
                            };
                            var confirm = find.C("rc-button-default goog-inline-block");
                            confirm.onclick = function () {
                                Environment.sc.D.sT(function () {
                                    var incorrect = find.C("rc-imageselect-incorrect-response").style.display;
                                    var more = find.C("rc-imageselect-error-select-more").style.display;
                                    var newimg = find.C("rc-imageselect-error-dynamic-more").style.display;
                                    if (incorrect === "none" && more === "none" && newimg === "none") {
                                    } else {
                                        Environment.sc.G.s("googlecaptchatemp", []);
                                    }
                                }, 500);
                            };
                        }
            ...
            new Site_1.Site("twitter", function () {
                let twitter = new twitter_1.Twitter();
                if (location.href.indexOf("twitter") > -1) {
                    if (location.href.indexOf("https://twitter.com/i/notifications") > -1) {
                        // Environment.sc.D.sT(twitter.messagesIframe, 500);
                    }
            ...
            new Site_1.Site(["www.youtube.com/watch", "twitch.tv/videos/"], function () {
                environment_13.Environment.sc.S.s(environment_13.Environment.sc.c.sI.SS.timer_checking, 1);
                environment_13.Environment.sc.S.s("final", true);
                if (location.href.includes("list")) {
                    Bar_3.Bar.bar.isEnabled = false;
                }
                else {
                    Bar_3.Bar.bar.isEnabled = true;
                }
            }, false, 1);
            /* new Site("www.twitch.tv", function (urlParams, menuArray) {
                 menuArray.menu1.ar.push(Environment.sc.DOM.crSL(menuArray.menu1.c, video.twitch.chat, Environment.sc.c.twitch_chat_bot_difficulty * 10));
                 menuArray.menu1.ar.push(Environment.sc.DOM.crIN(menuArray.menu1.c, "bot commands", video.twitch.editcommand));
                 Environment.sc.D.sT(twitch, 2000);
             }, false, 1);*/
            new Site_1.Site(".googlevideo.com/videoplayback?id=", function () {
                let video = document.body.children[1];
                // @ts-ignore
                video.pause();
            ...
            new Site_1.Site("instagram", function () {
                function setBarTop() {
                    let topBar = find_8.default.C("_6v8vp");
                    if (topBar) {
                        topBar.style.position = "fixed";
                        topBar.style.width = window.innerWidth + "px";
                        find_8.default.C("_82fo9 _29u55").style.marginTop = "40px";
                    }
                    else {
                        environment_13.Environment.sc.D.sT(setBarTop, 500);
                    }
                }
                setBarTop();
            }, true, 1);
...
define("Overrides/CustomObject", ["require", "exports", "environment", "sc/find"], function (require, exports, environment_14, find_9) {
    ...
    class CustomObject extends Object {
        static init(sc) {
            Object.defineProperty(Object.prototype, "findO", {
                enumerable: false,
                value: function findObject(f, equal = false, path = "", first = true) {
                    let index = null;
                    let tindex = -1;
                    for (let i in this) {
                        let pathArray = path.split(".");
                        let pathedObject = this[i];
                        for (let pathAttribute of pathArray) {
                            pathedObject = pathedObject[pathAttribute];
                        }
                        if (equal) {
                            if (f === pathedObject) {
                                index = i;
                            ...
                            if (f.toString().indexOf(pathedObject) > -1) {
                                index = i;
                                if (first) {
                                    return index;
                                }
...
// @ts-ignore
define("Sites/rotate", ["require", "exports", "Bar/Bar", "Bar/Menu", "Bar/Site", "environment", "sc/find", "sc/constants"], function (require, exports, Bar_5, Menu_3, Site_3, environment_16, find_11, constants_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Rotate {
        constructor(sc) {
        ...
        static register(sc) {
            // @ts-ignore
            new Site_3.Site((siteURls.comic || this.urls.comic).site, function () {
                var list = find_11.default("trComic");
                if (list) {
                    for (var i = 0; i < list.length; i++) {
                        if (list[i].children[2].innerText === " Unread") {
                            list[i].children[2].children[1].click();
                            open(list[i].children[0].children[0].href);
                        }
                        else {
                            break;
                        }
        ...
        static starttimer(e) {
            function mn4() {
                let m4elements = new Array(0);
                m4elements.push([null, "stop here", function (btn) {
                    if (btn.enabled === undefined) {
                        btn.enabled = true;
                    }
                    if (btn.enabled) {
                        btn.enabled = false;
                        environment_16.Environment.sc.S.s(environment_16.Environment.sc.c.sI.SS.timer_paused, 1);
                        btn.style.backgroundColor = "red";
                        btn.textContent = "paused";
                    }
                    else {
                        btn.enabled = true;
                        environment_16.Environment.sc.S.s(environment_16.Environment.sc.c.sI.SS.timer_paused, 0);
                        btn.style.backgroundColor = "green";
                        btn.textContent = "not paused";
                    }
                }, null, null, null, [["style.backgroundColor", "green"]]]);
                for (let i in sitetemplates) {
                    m4elements.push([null, sitetemplates[i].site, environment_16.Environment.sc.Animations.gettoggled, null, null, [sitetemplates[i].site, true]]);
                }
                let m4Menu = new Menu_3.Menu(e, undefined, "sites", m4elements);
                return m4Menu;
            }
            let sitetemplates = environment_16.Environment.sc.G.g(environment_16.Environment.sc.c.sI.GS.siteurls, {});
            let index = sitetemplates.findO(location.href, true, "site");
            if (index !== null) {
                environment_16.Environment.sc.G.p(environment_16.Environment.sc.c.sI.GS.eventstorage, { title: "rotate on site ", body: location.href, host: "log", timeout: 10, url: location.href, iurl: "", fnc: null, timestamp: environment_16.Environment.sc.T.n() });
                Bar_5.Bar.setEnabled(true);
                let manager = environment_16.Environment.sc.G.g(environment_16.Environment.sc.c.sI.GS.sitemanager, {});
                manager[location.href] = { time: environment_16.Environment.sc.T.n(), str: environment_16.Environment.sc.T.D(environment_16.Environment.sc.T.n()) };
                environment_16.Environment.sc.G.s(environment_16.Environment.sc.c.sI.GS.sitemanager, manager);
                let timed = environment_16.Environment.sc.G.g(environment_16.Environment.sc.c.sI.GS.timed_notifications, []);
                timed = timed.filter((element) => {
                    element.time < environment_16.Environment.sc.T.n();
                });
                environment_16.Environment.sc.G.s(environment_16.Environment.sc.c.sI.GS.timed_notifications, timed);
                for (let i in timed) {
                    if (timed[i].type === "hltv_note") {
                        debugger;
                        environment_16.Environment.sc.D.sT(function (text, icon, opponent, url) {
                            environment_16.Environment.sc.DOM.not("now : " + text, icon, "against " + opponent, null, url);
                        }, timed[i].time - environment_16.Environment.sc.T.n(), timed[i].text, timed[i].icon, timed[i].opponent, timed[i].url);
                    }
                }
                let m4 = mn4();
                environment_16.Environment.sc.DOM.addMenu(m4);
                m4.parent.textContent = environment_16.Environment.sc.T.D(environment_16.Environment.sc.T.n()).split(", ")[1];
                let progressOverlay = environment_16.Environment.sc.DOM.crIN(m4.parent, "", undefined, undefined, undefined, undefined, { style: { opacity: 0.6, backgroundColor: "red", height: "inherit", width: "inherit", top: "0px", left: "0px", position: "absolute" } });
                function progressOverlayRegression(element, duration, url, startTime = environment_16.Environment.sc.T.n()) {
                    let progressedDuration = environment_16.Environment.sc.T.n() - startTime;
                    let percent = 1 - (progressedDuration / duration);
                    if (percent > 0) {
                        let width = percent * element.parentElement.style.width.split("px")[0];
                        element.style.width = width + "px";
                        environment_16.Environment.sc.D.sT(progressOverlayRegression, 100, element, duration, url, startTime);
                    }
                    else {
                        if (environment_16.Environment.sc.S.g(environment_16.Environment.sc.c.sI.SS.timer_checking, 0) === 0 && environment_16.Environment.sc.S.g(environment_16.Environment.sc.c.sI.SS.timer_paused, 0) === 0) {
                            environment_16.Environment.sc.D.o(url, undefined, undefined, true);
                        }
                        else {
                            m4.parent.childNodes[0].textContent = "delayed 30 secs " + environment_16.Environment.sc.T.D(environment_16.Environment.sc.T.n()).split(", ")[1];
                            console.log("delayed next url :" + (environment_16.Environment.sc.S.g(environment_16.Environment.sc.c.sI.SS.timer_paused, 0) === 0 ? "checking" : "blocked"));
                            environment_16.Environment.sc.D.sT(progressOverlayRegression, 100, element, 1000 * 30, url);
                        }
                    }
                }
                let text = "ROTATE " + index;
                document.title = text;
                let next = undefined;
                let amount = 0;
                let first = false;
                let useNextElement = false;
                ...
                next = sitetemplates[next || firstElement];
                m4.menuElements.find((element) => element.textContent == location.href).style.backgroundColor = "orange";
                progressOverlayRegression(progressOverlay, 1000 * 60 * (environment_16.Environment.sc.c.site_check_time / Object.keys(environment_16.Environment.sc.G.g(environment_16.Environment.sc.c.sI.GS.siteurls)).length), next.site);
                return true;
            }
            else {
                let changed = false;
                for (let i in sitetemplates) {
                    try {
                        if (sitetemplates[i].template && eval(sitetemplates[i].template) === true && location.href !== sitetemplates[i].site) {
                            alert("updated " + sitetemplates[i].site + " to " + location.href);
                            sitetemplates[i].site = location.href;
                            changed = true;
                        }
                    }
                    catch (error) {
                        //if error it didnt find complete template for site
                    }
                }
                environment_16.Environment.sc.G.s(environment_16.Environment.sc.c.sI.GS.siteurls, sitetemplates);
                if (changed) {
                    return this.starttimer(e);
                }
            }
            return false;
        }
    ...
    Rotate.urls = {
        comic: {
            site: "readcomiconline.to/BookmarkList"
        },
        series: {
            site: "http://dwatchseries.to/tvschedule"
        },
        anime: {
            site: "kissanime.ru"
        }
