 ...
 */
const buttonScript = document.currentScript;
buttonScript.isAsync = true;
buttonScript.isModular = true;
(async function () {
    /**
     *  @name dom_b
     */
                ...
                if (style) {
                    if (style.constructor.name === "Object") {
                        ...
                        for (let i = 0; i < style.length; i++) {
                            btn[style[i][0]] = JSON.stringify(style[i][1]);
                        }
                    }
                    if (btn['property']) {
